...
public final class LowerUnitriangularBuilder {
    ...
    public LowerUnitriangularEntryReadableMatrix build() {
        ...
        LowerUnitriangularEntryReadableMatrix out =
                new LowerUnitriangularMatrixImpl(this.matrixDimension, this.lowerEntry);
    ...
    public static LowerUnitriangularBuilder unitBuilder(final MatrixDimension matrixDimension) {
        return new LowerUnitriangularBuilder(matrixDimension);
    }

    private static final class LowerUnitriangularMatrixImpl extends SkeletalMatrix
