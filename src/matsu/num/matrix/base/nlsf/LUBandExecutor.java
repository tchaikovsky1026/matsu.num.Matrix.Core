 ...
 * 
 * <p>
 * 与えられた正方帯行列 A を次の形に分解する: A = LDU. ただし, L: 単位(対角成分が1の)下三角帯行列, D: 対角行列, U:
 * 単位上三角帯行列. <br>
...
public final class LUBandExecutor {
    ...
    private static final class LUBandFactorization extends SkeletalLinearEquationSolving<BandMatrix>
         ...
         * @throws ProcessFailedException 行列が特異の場合, あるいはピボッティングが必要な場合, 成分に極端な値を含み分解が完了できない場合
         */
        ...
        InverseAndDeterminantStructure<Matrix> calcInverseAndDeterminantStructure() {
            ...
            return new InverseAndDeterminantStructure<>(det, invMatrix);
        }
