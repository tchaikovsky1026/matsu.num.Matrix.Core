...
public final class SymmetricBandMatrixBuilder {
     ...
     * @throws IllegalArgumentException 行列の有効要素数が大きすぎる場合(dim * b > IntMax)
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    private SymmetricBandMatrixBuilder(final BandMatrixDimension bandMatrixDimension) {
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    private SymmetricBandMatrixBuilder(final SymmetricBandMatrixImpl src) {
     ...
     * @throws IllegalStateException すでにビルドされている場合
     */
    public BandMatrix build() {
        if (Objects.isNull(this.diagonalEntry)) {
            throw new IllegalStateException("すでにビルドされています");
        }
        SymmetricBandMatrixImpl out = new SymmetricBandMatrixImpl(bandMatrixDimension, diagonalEntry, bandEntry);
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    public static SymmetricBandMatrixBuilder zeroBuilder(final BandMatrixDimension bandMatrixDimension) {
        return new SymmetricBandMatrixBuilder(bandMatrixDimension);
    }
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    public static SymmetricBandMatrixBuilder unitBuilder(final BandMatrixDimension bandMatrixDimension) {
        SymmetricBandMatrixBuilder outBuilder = new SymmetricBandMatrixBuilder(bandMatrixDimension);
     ...
     * @see Symmetric
     */
    public static SymmetricBandMatrixBuilder from(final BandMatrix src) {
        ...
        if (src instanceof SymmetricBandMatrixImpl) {
            return new SymmetricBandMatrixBuilder((SymmetricBandMatrixImpl) src);
        }
        ...
        final SymmetricBandMatrixBuilder outBuilder = new SymmetricBandMatrixBuilder(bandMatrixDimension);
        ...
        for (int i = 0; i < srcDimension; i++) {
            ...
            if (!EntryReadableMatrix.acceptValue(value)) {
                throw new AssertionError(
                        String.format(
                                "BandMatrixが適切に実装されていない: entryValue=%.16G", value));
            }
    ...
    private static final class SymmetricBandMatrixImpl extends SkeletalMatrix
         ...
         * ビルダから呼ばれる.
         */
        private SymmetricBandMatrixImpl(BandMatrixDimension bandMatrixDimension,
