...
public final class GeneralBandMatrixBuilder {
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    private GeneralBandMatrixBuilder(final GeneralBandMatrixImpl src) {
    ...
    public BandMatrix build() {
        ...
        GeneralBandMatrixImpl out = new GeneralBandMatrixImpl(
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    public static GeneralBandMatrixBuilder zeroBuilder(final BandMatrixDimension bandMatrixDimension) {
        return new GeneralBandMatrixBuilder(bandMatrixDimension);
    }
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    public static GeneralBandMatrixBuilder unitBulder(final BandMatrixDimension bandMatrixDimension) {
        GeneralBandMatrixBuilder outBuilder = new GeneralBandMatrixBuilder(bandMatrixDimension);
     ...
     * @throws NullPointerException 引数にnullが含まれる場合
     */
    public static GeneralBandMatrixBuilder from(final BandMatrix src) {
        final BandMatrixDimension bandMatrixDimension = src.bandMatrixDimension();
        if (src instanceof GeneralBandMatrixImpl) {
            return new GeneralBandMatrixBuilder((GeneralBandMatrixImpl) src);
        }
        ...
        final GeneralBandMatrixBuilder outBuilder = new GeneralBandMatrixBuilder(bandMatrixDimension);
    ...
    private static final class GeneralBandMatrixImpl extends SkeletalMatrix implements BandMatrix {
         ...
         * ビルダから呼ばれる.
         */
        private GeneralBandMatrixImpl(final BandMatrixDimension bandMatrixDimension,
